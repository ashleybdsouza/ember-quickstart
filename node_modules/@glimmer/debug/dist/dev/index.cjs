...
const METADATA = new Array(vm.Op.Size).fill(null);
const MACHINE_METADATA = new Array(vm.Op.Size).fill(null);
MACHINE_METADATA[vm.MachineOp.PushFrame] = {
  name: 'PushFrame',
  mnemonic: 'pushf',
  before: null,
  stackChange: 2,
...
MACHINE_METADATA[vm.MachineOp.PopFrame] = {
  name: 'PopFrame',
  mnemonic: 'popf',
  before: null,
  stackChange: -2,
...
MACHINE_METADATA[vm.MachineOp.InvokeVirtual] = {
  name: 'InvokeVirtual',
  mnemonic: 'vcall',
  before: null,
  stackChange: -1,
...
MACHINE_METADATA[vm.MachineOp.InvokeStatic] = {
  name: 'InvokeStatic',
  mnemonic: 'scall',
  before: null,
  stackChange: 0,
...
MACHINE_METADATA[vm.MachineOp.Jump] = {
  name: 'Jump',
  mnemonic: 'goto',
  before: null,
  stackChange: 0,
...
MACHINE_METADATA[vm.MachineOp.Return] = {
  name: 'Return',
  mnemonic: 'ret',
  before: null,
  stackChange: 0,
...
MACHINE_METADATA[vm.MachineOp.ReturnTo] = {
  name: 'ReturnTo',
  mnemonic: 'setra',
  before: null,
  stackChange: 0,
...
METADATA[vm.Op.SetNamedVariables] = {
...
METADATA[vm.Op.ConstantReference] = {
...
METADATA[vm.Op.PrimitiveReference] = {
...
METADATA[vm.Op.VirtualRootScope] = {
...
METADATA[vm.Op.AppendDocumentFragment] = {
...
METADATA[vm.Op.OpenDynamicElement] = {
...
METADATA[vm.Op.PushRemoteElement] = {
...
METADATA[vm.Op.PopRemoteElement] = {
...
METADATA[vm.Op.BindDynamicScope] = {
...
METADATA[vm.Op.PushDynamicScope] = {
...
METADATA[vm.Op.PopDynamicScope] = {
...
METADATA[vm.Op.PushSymbolTable] = {
...
METADATA[vm.Op.DynamicContentType] = {
...
METADATA[vm.Op.PushComponentDefinition] = {
...
METADATA[vm.Op.PushDynamicComponentInstance] = {
...
METADATA[vm.Op.ResolveDynamicComponent] = {
...
METADATA[vm.Op.CreateComponent] = {
...
METADATA[vm.Op.RegisterComponentDestructor] = {
...
METADATA[vm.Op.PutComponentOperations] = {
...
METADATA[vm.Op.GetComponentSelf] = {
...
METADATA[vm.Op.GetComponentTagName] = {
...
METADATA[vm.Op.GetComponentLayout] = {
...
METADATA[vm.Op.InvokeComponentLayout] = {
...
METADATA[vm.Op.BeginComponentTransaction] = {
...
METADATA[vm.Op.CommitComponentTransaction] = {
...
METADATA[vm.Op.DidCreateElement] = {
...
METADATA[vm.Op.DidRenderLayout] = {
...
METADATA[vm.Op.ResolveMaybeLocal] = {
...
exports.expectStackChange = expectStackChange;
