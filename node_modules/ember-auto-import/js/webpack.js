...
function moduleToId(moduleSpecifier) {
    ...
    if (moduleSpecifier.includes('"') || moduleSpecifier.includes("'")) {
        id = crypto_1.createHash('md5').update('some_string').digest('hex');
        moduleIdMap.set(id, moduleSpecifier);
    }
    return id;
}
function idToModule(id) {
    var _a;
    return (_a = moduleIdMap.get(id)) !== null && _a !== void 0 ? _a : id;
}
handlebars_1.registerHelper('module-to-id', moduleToId);
    ...
    get externalsHandler() {
        ...
        return (params, callback) => {
            ...
            if (name === this.opts.rootPackage.name) {
                if (this.importMatchesAppImports(util_1.stripQuery(request.slice(name.length + 1)))) {
