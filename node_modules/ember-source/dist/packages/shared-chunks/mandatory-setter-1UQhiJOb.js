...
if (isDevelopingApp()) {
  ...
  setupMandatorySetter = function (tag, obj, keyName) {
    ...
    Object.defineProperty(obj, keyName, {
      ...
      set(value) {
        (isDevelopingApp() && !(false) && assert(`You attempted to update ${this}.${String(keyName)} to "${String(value)}", but it is being tracked by a tracking context, such as a template, computed property, or observer. In order to make sure the context updates properly, you must invalidate the property when updating it. You can mark the property as \`@tracked\`, or use \`@ember/object#set\` to do this.`));
      }
    });
  };
